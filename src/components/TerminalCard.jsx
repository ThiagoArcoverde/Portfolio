export function TerminalCard() {
  return (
    <div className="terminal-card" role="region" aria-label="Resumo técnico">
      ...
      <div className="terminal-body">
        ...
        <p className="terminal-prompt"><span>➜</span> ready to build</p>
        <div className="terminal-rule terminal-rule-tight" />
        <div className="terminal-meta"><span>location</span><strong>Brazil, remote</strong></div>
        <div className="terminal-meta"><span>experience</span><strong>building since 2018</strong></div>
      </div>
    </div>
  )
}
